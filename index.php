...
<body>
  ...
  <div id="all" style="background-image: url(img/main-slider1.jpg)">
    <div id="content">
    ...
    <div id="hot">
      <div class="box py-4">
        <div class="container">
          <div class="row">
            <div class="col-md-12">
              <h2 class="mb-0">UPCOMING COURSES</h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="product">
              <div class="flip-container">
                <div class="flipper">
                  ...
                  <div class="back"><a href="#"><img src="img/product1_2.png" alt="" class="img-fluid"></a></div>
                </div>
              </div><a href="#" class="invisible"><img src="img/product1.jpg" alt="" class="img-fluid"></a>
              <div class="text">
                <h3><a href="#">Agro Industry Management</a></h3>
            ...
            <div class="product">
              <div class="flip-container">
                <div class="flipper">
                  ...
                  <div class="back"><a href="#"><img src="img/product2_2.png" alt="" class="img-fluid"></a></div>
                </div>
            ...
            <div class="product">
              <div class="flip-container">
                <div class="flipper">
                  ...
                  <div class="back"><a href="#"><img src="img/product3_2.png" alt="" class="img-fluid"></a></div>
                </div>
              </div><a href="#" class="invisible"><img src="img/product3.jpg" alt="" class="img-fluid"></a>
              <div class="text">
                <h3><a href="#">Arts General</a></h3>
              </div>
              <!-- /.text-->
              <div class="ribbon new">
                <div class="theribbon">NEW</div>
