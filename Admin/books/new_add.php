...
//$select= $db->prepare('SELECT * FROM user WHERE email = :e');	//sql select query
//$select->bindParam(':e',$e);
//$select->execute();
...
if(isset($_REQUEST['btn_insert']))
{
	try
	{
		...
		{
			$errorMsg="Upload PDF File Format.....CHECK FILE EXTENSION"; //error message file extension
		}

		if(!isset($errorMsg))
		{
			$insert_stmt=$db->prepare('INSERT INTO tbl_books(name,file) VALUES(:fname,:fimage)'); //sql insert query
