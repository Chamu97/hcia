...
if(isset($_REQUEST['update_id']))
{
	try
	{
		...
		$select_stmt = $db->prepare('SELECT * FROM tbl_books WHERE id =:id'); //sql select query
...
if(isset($_REQUEST['btn_update']))
{
 ...
 if($image_file)
 {
  ...
  $valid_extensions = array('pdf'); // valid extensions
	...
	{
	 $errorMsg="Upload PDF File Formate.....CHECK FILE EXTENSION"; //error message file extension
	}
}
 else
 {
	$image_file=$row['file']; //if you not select new image than previous image sam it is it.
		...
		if(!isset($errorMsg))
		{
			$update_stmt=$db->prepare('UPDATE tbl_books SET name=:name_up, file=:file_up WHERE id=:id'); //sql update query
			   ...
			   <div class="row">
			       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			           <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
			               ...
			               <li><a href="index.php" style="color: #a4b2a8;"><i class="notika-icon notika-file"></i> View References</a>
			               </li>
			               <li><a href="../../index.php" style="color: #a4b2a8;"><i class="notika-icon notika-right-arrow"></i> Sign Out</a>
			               </li>
			           </ul>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="data-table-list">
                      ...
                      <div class="basic-tb-hd">
                          <h2 class="text-center">Edit References</h2>
                      </div>
                      <br>
                      <div class="wrapper">
