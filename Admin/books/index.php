...
if(isset($_REQUEST['delete_id']))
{
  ...
  $delete_stmt = $db->prepare('DELETE FROM tbl_books WHERE id =:id');
   ...
   <div class="row">
       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
           <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
               ...
               <li><a href="new_add.php" style="color: #a4b2a8;"><i class="notika-icon notika-file"></i> Upload References</a>
               </li>
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $select_stmt=$db->prepare("SELECT * FROM tbl_books");	//sql select query
                    $select_stmt->execute();
