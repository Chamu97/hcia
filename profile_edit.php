                                ...
                                <form>
																	...
																	<div class="row">
																			<div class="col-md-6">
																					<div class="form-group">
																							...
																							<input type="text" class="form-control" placeholder="Company" value="<?php echo $fname;?>">
																					</div>
																			</div>
																			<div class="col-md-6">
																					<div class="form-group">
  																...
  																<div class="row">
																	...
																	<div class="col-md-4">
																			<div class="form-group">
																					<label>Mobile</label>
																					<input type="text" class="form-control" placeholder="Mobille" value="michael23">
																			</div>
																	</div>
                                  </div>
                            ...
                            <div class="content">
                                <div class="author">
                                    <img class="avatar border-gray" src="images/faces/face-1.jpg" alt="..."/>
                                      ...
                                      <h4 class="title"><?php echo $fname = "Chamika";?> <?php echo $lname = "Muthukumarana";?><br />
																				<br>
                                      </h4>
