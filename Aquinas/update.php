...
<div class="container ">
    ...
    <form action="" method="POST" style="margin-top: -500px; margin-left:200px" enctype="multipart/form-data" >
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input type="text" name ="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Lecture 1" value="">
            </div>
        ...
        <div class="form-group row" style="margin-top: 10px">
            ...
            <div class="col-md-6">
                <select name = "id" class="form-control" id="exampleFormControlSelect1" style="margin-top: 10px" placeholder="Humen Computer Intteraction" >
    ...
    <nav class="navbar navbar-expand-sm sticky-top" style="margin-top: -350px">
        ...
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link nav-link text-dark fas fa-arrow-circle-left " href="./ViewCourses.php">Back</a></div>
