        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <!-- <div class="section-header text-center">
              <h2 class="title">Diploma Programs</h2> -->
                ...
                if(isset($_POST['search'])){
                    ...
                    if($search != ''){
                      ...
                      $sql1 = " SELECT * FROM all_programs WHERE program_category  = 'DIPLOMA PROGRAMS' AND program_name LIKE '%".$search."%' OR program_code LIKE '%".$search."%'";
                      $search_results = filterTable($sql1);
                      //$search_results = mysqli_query($db,$sql1);
                    }else{

                       $sql1 = "SELECT * FROM all_programs WHERE program_category  = 'DIPLOMA PROGRAMS'";
              ...
              <div class="container">
                    <div class="data-table-list">
                      <div class="row">
                        ...
                        <div class="col-sm-8">
                          <div class="section-header text-center">
                            <h2 class="title title-style">Diploma Programs</h2>
                          </div>
                                ...
                                <table id="courseTable" class="table table-striped">
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <a href="programs-view-page.php?did=<?php echo $cs['program_id']; ?>" class="btn btn-info">Read More <i class="fa fa-arrow-right"></i></a>
                                      </td>
                                    </tr>
                                  <?php } ?>
                                  </tbody>
